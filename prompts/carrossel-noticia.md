# Prompt: Carrossel Notícia + Narrativa + Reflexão
...
passo a passo, na criação de um carrossel que conecta uma notícia ou
curiosidade com o nicho dele e termina puxando seguidor para o perfil.
...
## Etapa 2. Buscar assuntos virais (web)

Faça DUAS buscas separadas na internet, usando o nicho informado. As
duas categorias têm regras diferentes e precisam ser apresentadas
separadas no chat.

### Categoria A. NOTÍCIA TEMPORAL (frescor obrigatório)
...
- Se NENHUMA notícia relevante existir nos últimos 7 dias, diga ao
  usuário com sinceridade: "Nada quente nos últimos 7 dias. Quer focar
  só em Notícia Atemporal?". NÃO invente, NÃO recicle notícia velha.
...
### Categoria B. NOTÍCIA ATEMPORAL (sem prazo de validade)

**Conteúdo aceito**

Curiosidades, fatos chocantes, dados contraintuitivos, descobertas
históricas, bastidores conhecidos, recordes, tragédias marcantes,
estatísticas inusitadas do nicho. A âncora é o tema, não a data.

**Regra**

A matéria original pode ter sido publicada há meses ou anos. O critério
é "ainda gera curiosidade hoje". Não importa se é de 2018 ou de 2024.

### Como apresentar ao usuário

Levante EXATAMENTE 3 ideias por categoria (3 Trend + 3 Atemporal,
sempre 6 no total). Cada ideia tem três linhas:
- Título + data (só nas Trend)
...
Apresente as duas categorias com cabeçalhos em destaque e numeração
REINICIADA em cada uma (1, 2, 3 em Trend e 1, 2, 3 em Atemporal), no
...
1. [título da curiosidade]
   Gancho: [como conecta com o nicho do mentorado]
   Fonte: [URL completa da matéria ou referência]
...
REGRAS DAS FONTES
- A fonte é OBRIGATÓRIA em todas as 6 ideias (Trend e Atemporal).
...
Se a categoria Trend vier vazia (nada nos últimos 7 dias), apresente
só Atemporais com 6 opções e avise o usuário no topo:

> Nada quente nos últimos 7 dias no seu nicho. Vamos com 6 ideias de
> Notícia Atemporal.
...
Pergunte: "Qual você quer transformar em carrossel? Responda com a
categoria e o número (ex: Trend 2 ou Atemporal 1)."

Se a categoria Trend tiver vindo vazia e você apresentou 6 atemporais
numeradas de 1 a 6, pergunte só "Qual das 6 você quer? Digite o
número."
...
`carrossel-[slug-do-tema]-[YYYY-MM-DD].txt`

Exemplo: `carrossel-medina-wsl-2026-05-09.txt`
...
>
> **Caminho 2. Automação**
> Baixe o arquivo `carrossel-[slug]-[data].txt` e suba na sua automação
> (n8n, Make, Zapier, script Python). Cada slide está delimitado por
> `=== SLIDE N ===` e `=== FIM SLIDE N ===` e marcado com a linha
> `MODO: X`. Sua automação parseia, identifica o modo e roteia para a
> API certa (Code Interpreter via Assistants API ou DALL-E via Images
> API).
