---
name: "source-command-criativo-estatico-ugc-coisas-estranhas"
description: "Migrated source command `criativo-estatico-ugc-coisas-estranhas`"
---

# source-command-criativo-estatico-ugc-coisas-estranhas

Use this skill when the user asks to run the migrated source command `criativo-estatico-ugc-coisas-estranhas`.
...
Antes de mostrar ao aluno, aplique a rotina de auto-revisão obrigatória do AGENTS.md (Manual da Copy + revisora) no título e na legenda. Corrigir direto, nunca mostrar versão bruta. O texto da imagem (título da arte, explicação, CTA) e o prompt de animação NÃO passam pela revisora (são conteúdo da arte com tom específico), mas devem respeitar Light Copy: sem travessão, sem exclamação, e o título sempre contém o nicho de forma clara.
