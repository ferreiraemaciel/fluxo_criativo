---
name: "source-command-criativo-estatico-promessa-simples"
description: "Migrated source command `criativo-estatico-promessa-simples`"
---

# source-command-criativo-estatico-promessa-simples

Use this skill when the user asks to run the migrated source command `criativo-estatico-promessa-simples`.
