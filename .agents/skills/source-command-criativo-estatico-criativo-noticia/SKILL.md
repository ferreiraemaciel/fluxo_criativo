---
name: "source-command-criativo-estatico-criativo-noticia"
description: "Migrated source command `criativo-estatico-criativo-noticia`"
---

# source-command-criativo-estatico-criativo-noticia

Use this skill when the user asks to run the migrated source command `criativo-estatico-criativo-noticia`.
