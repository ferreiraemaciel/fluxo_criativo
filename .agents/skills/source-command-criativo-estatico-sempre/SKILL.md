---
name: "source-command-criativo-estatico-sempre"
description: "Migrated source command `criativo-estatico-sempre`"
---

# source-command-criativo-estatico-sempre

Use this skill when the user asks to run the migrated source command `criativo-estatico-sempre`.
