---
name: "source-command-criativo-estatico-jeito-certo-jeito-errado"
description: "Migrated source command `criativo-estatico-jeito-certo-jeito-errado`"
---

# source-command-criativo-estatico-jeito-certo-jeito-errado

Use this skill when the user asks to run the migrated source command `criativo-estatico-jeito-certo-jeito-errado`.
...
- Pode incluir tela com Codex/ChatGPT aberto pra nicho de IA
