---
name: "source-command-obter-id-conta-anuncios"
description: "Migrated source command `obter-id-conta-anuncios`"
---

# source-command-obter-id-conta-anuncios

Use this skill when the user asks to run the migrated source command `obter-id-conta-anuncios`.
