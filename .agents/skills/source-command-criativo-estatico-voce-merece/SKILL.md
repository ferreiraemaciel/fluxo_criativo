---
name: "source-command-criativo-estatico-voce-merece"
description: "Migrated source command `criativo-estatico-voce-merece`"
---

# source-command-criativo-estatico-voce-merece

Use this skill when the user asks to run the migrated source command `criativo-estatico-voce-merece`.
...
Auto-revisão obrigatória: aplicar a rotina de auto-revisão de copy do AGENTS.md (carregar Manual da Copy + acionar a skill `revisora`) no título e na legenda. Corrigir direto. Nunca mostrar versão bruta.
...
Toda legenda pro Instagram entregue por esta sub-skill deve ter **no mínimo 3 linhas**, redigida seguindo os princípios do Manual da Copy (`.Codex/skills/revisora/references/manual-copy.md`):
