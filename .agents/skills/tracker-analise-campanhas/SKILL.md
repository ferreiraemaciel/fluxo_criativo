...
> pra não depender de uma sessão do Codex rodando toda vez que o Felipe (ou a
...
de montar o comando, igual qualquer chamada a Graph API do AGENTS.md raiz, nunca deixar
