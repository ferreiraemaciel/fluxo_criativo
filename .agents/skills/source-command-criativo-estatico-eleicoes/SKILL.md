---
name: "source-command-criativo-estatico-eleicoes"
description: "Migrated source command `criativo-estatico-eleicoes`"
---

# source-command-criativo-estatico-eleicoes

Use this skill when the user asks to run the migrated source command `criativo-estatico-eleicoes`.
