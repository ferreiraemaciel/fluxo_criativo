---
name: "source-command-criativo-estatico-ugc-rotina-real"
description: "Migrated source command `criativo-estatico-ugc-rotina-real`"
---

# source-command-criativo-estatico-ugc-rotina-real

Use this skill when the user asks to run the migrated source command `criativo-estatico-ugc-rotina-real`.
