---
name: "source-command-criativo-estatico-nunca"
description: "Migrated source command `criativo-estatico-nunca`"
---

# source-command-criativo-estatico-nunca

Use this skill when the user asks to run the migrated source command `criativo-estatico-nunca`.
