---
name: "source-command-criativo-estatico-centro-das-atencoes"
description: "Migrated source command `criativo-estatico-centro-das-atencoes`"
---

# source-command-criativo-estatico-centro-das-atencoes

Use this skill when the user asks to run the migrated source command `criativo-estatico-centro-das-atencoes`.
