---
name: "source-command-criativo-estatico-checklist"
description: "Migrated source command `criativo-estatico-checklist`"
---

# source-command-criativo-estatico-checklist

Use this skill when the user asks to run the migrated source command `criativo-estatico-checklist`.
