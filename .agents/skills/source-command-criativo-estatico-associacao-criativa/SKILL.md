---
name: "source-command-criativo-estatico-associacao-criativa"
description: "Migrated source command `criativo-estatico-associacao-criativa`"
---

# source-command-criativo-estatico-associacao-criativa

Use this skill when the user asks to run the migrated source command `criativo-estatico-associacao-criativa`.
...
Antes de mostrar ao aluno: aplicar a rotina de auto-revisão de copy do AGENTS.md (carregar Manual da Copy + acionar a skill `revisora`) na legenda. Corrigir direto. Nunca mostrar versão bruta.
