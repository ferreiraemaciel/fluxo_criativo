---
name: "source-command-criativo-estatico-copa"
description: "Migrated source command `criativo-estatico-copa`"
---

# source-command-criativo-estatico-copa

Use this skill when the user asks to run the migrated source command `criativo-estatico-copa`.
