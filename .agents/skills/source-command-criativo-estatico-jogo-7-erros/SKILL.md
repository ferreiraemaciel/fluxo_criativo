---
name: "source-command-criativo-estatico-jogo-7-erros"
description: "Migrated source command `criativo-estatico-jogo-7-erros`"
---

# source-command-criativo-estatico-jogo-7-erros

Use this skill when the user asks to run the migrated source command `criativo-estatico-jogo-7-erros`.
