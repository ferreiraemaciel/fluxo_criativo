---
name: "source-command-criativo-estatico-pov"
description: "Migrated source command `criativo-estatico-pov`"
---

# source-command-criativo-estatico-pov

Use this skill when the user asks to run the migrated source command `criativo-estatico-pov`.
