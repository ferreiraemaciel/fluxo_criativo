---
name: "source-command-criativo-estatico-criativo-surreal"
description: "Migrated source command `criativo-estatico-criativo-surreal`"
---

# source-command-criativo-estatico-criativo-surreal

Use this skill when the user asks to run the migrated source command `criativo-estatico-criativo-surreal`.
...
Antes de mostrar ao aluno: aplicar a rotina de auto-revisão de copy do AGENTS.md (carregar Manual da Copy + acionar a skill `revisora`) no título (que é o headline) e na legenda. Corrigir direto. Nunca mostrar versão bruta.
