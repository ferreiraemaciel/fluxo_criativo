---
name: "source-command-trafego-analise"
description: "Migrated source command `trafego-analise`"
---

# source-command-trafego-analise

Use this skill when the user asks to run the migrated source command `trafego-analise`.
...
- **Se `MCP_CONECTOR`:** confirmar que pelo menos uma tool com prefixo `mcp__*__ads_*` está disponível. Se nenhuma, pedir ao aluno para reabrir o Codex.
...
| Output | Sub-skill |
|--------|-----------|
| [1] | `.Codex/skills/trafego-analise/sub-skills/1-diagnostico-rapido.md` |
| [2] | `.Codex/skills/trafego-analise/sub-skills/2-performance-funil.md` |
| [3] | `.Codex/skills/trafego-analise/sub-skills/3-criativos.md` |
| [4] | `.Codex/skills/trafego-analise/sub-skills/4-geo-demografia.md` |
| [5] | `.Codex/skills/trafego-analise/sub-skills/5-timing-sazonalidade.md` |
| [6] | `.Codex/skills/trafego-analise/sub-skills/6-investigacao-profunda.md` |
| [7] | `.Codex/skills/trafego-analise/sub-skills/7-lifecycle-historico.md` |
| [8] | `.Codex/skills/trafego-analise/sub-skills/8-problemas-ocultos.md` |
| [9] | `.Codex/skills/trafego-analise/sub-skills/9-orcamento-projecao.md` |
| [10] | `.Codex/skills/trafego-analise/sub-skills/10-comparativo.md` |
...
Se `s`: acionar `.Codex/skills/trafego-analise/sub-skills/_export-html.md`.
