---
name: "source-command-criativo-estatico-fofinho"
description: "Migrated source command `criativo-estatico-fofinho`"
---

# source-command-criativo-estatico-fofinho

Use this skill when the user asks to run the migrated source command `criativo-estatico-fofinho`.
...
Antes de mostrar ao aluno: aplicar a rotina de auto-revisão de copy do AGENTS.md (carregar Manual da Copy + acionar a skill `revisora`) no título e na legenda. Corrigir direto. Nunca mostrar versão bruta.
