---
name: "source-command-criativo-estatico-desespero-de-quem"
description: "Migrated source command `criativo-estatico-desespero-de-quem`"
---

# source-command-criativo-estatico-desespero-de-quem

Use this skill when the user asks to run the migrated source command `criativo-estatico-desespero-de-quem`.
...
Antes de mostrar ao aluno, aplique a rotina de auto-revisão obrigatória de copy do AGENTS.md (carregar Manual da Copy + acionar a skill `revisora`) na legenda. Corrigir direto. Nunca mostrar versão bruta.
