---
name: "source-command-criativo-estatico-asmr-sensacao"
description: "Migrated source command `criativo-estatico-asmr-sensacao`"
---

# source-command-criativo-estatico-asmr-sensacao

Use this skill when the user asks to run the migrated source command `criativo-estatico-asmr-sensacao`.
