/* ================================================================
   Quiz Fotógrafo Protegido — definição do funil (editável)
   As "key" batem com as colunas da tabela quiz_leads no Supabase,
   e os textos das opções batem com o histórico do inLead (para os
   gráficos do Tracker juntarem histórico + novos leads).
   ================================================================ */
window.QUIZ_CONFIG = {
  funnelSlug: 'fotografo-protegido',
  checkoutUrl: 'https://pay.hotmart.com/W87258826R?checkoutMode=10',
  preco: { de: 'R$ 497,00', por: 'R$ 297,00', parcelas: '12x R$ 30,72' },
  ...
  steps: [
    ...
    { type: 'content',
      key: 'quer_modelos',
      heading: 'Contrato não é textão para advogado.',
      imgs: [
        { src: 'assets/clausula-01.jpg', title: 'Cláusula em contrato Textão no Word', caption: 'Difícil de entender e juridiquês desnecessário.' },
        { src: 'assets/clausula-02.jpg', title: 'Cláusula Visual', caption: 'Identidade visual que facilita a compreensão e define as regras do jogo.' },
      ],
      body: 'Quem assina o contrato não é só advogado ou juiz, é o <b>fotógrafo, o videomaker e o cliente</b>. Por isso o que funciona é a Cláusula Visual: rápida de preencher, fácil de entender e com segurança jurídica.',
      question: 'Ter um contrato com cláusulas assim te ajudaria?',
      options: [
        { emoji: '✅', label: 'Sim, preciso disso agora. Estou sem proteção.' },
    ...
    { type: 'loading',
      ...
      heading: 'Com os Modelos de Contrato Visual você ganha:',
      duration: 4500,
      items: [
        { emoji: '📋', title: 'Segurança Jurídica', body: 'Proteja seu negócio contra imprevistos e evite prejuízos.' },
        { emoji: '🚀', title: 'Uso Imediato', body: 'Baixe, preencha e utilize agora mesmo!' },
        { emoji: '⚡', title: 'Agilidade e Praticidade', body: 'Modelos prontos para economizar seu tempo.' },
        { emoji: '🤩', title: 'Cláusulas Claras e Simples', body: 'Você e seu cliente entendem tudo sem complicação.' },
        { emoji: '🛡️', title: 'Profissionalismo e Proteção em um só lugar!' },
      ],
