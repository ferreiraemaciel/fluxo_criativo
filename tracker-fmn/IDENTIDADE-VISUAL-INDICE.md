...
O conteúdo precisa de lista, sequência de passos, comparação em colunas,
ou é grande demais pra caber numa frase ou numa foto só?
  → CARROSSEL
```
...
## Regras que valem pros 3 formatos
...
- **`@felipeferreirafotografo` é obrigatório em toda peça**, sem exceção. Cada formato tem sua
  posição fixa (ver doc específico), mas a presença do @ não é opcional em nenhum dos três.
