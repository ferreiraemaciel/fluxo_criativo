-- Migration 032: adiciona criativo_qualidade ao quiz_funis_dashboard
-- Agrupa por utm_content (nome do anúncio, sem o |ad_id do final)
-- para mostrar qual criativo gerou mais leads e com maior % de alto risco.
